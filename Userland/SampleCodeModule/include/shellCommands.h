...
#define WRONG_PARAM_1 "Cantidad de parametros incorrecta. Se espera 1 parametro.\n"
#define WRONG_PARAM_2 "Cantidad de parametros incorrecta. Se esperan 2 parametros.\n"
